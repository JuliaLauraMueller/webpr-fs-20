...
oscillator.frequency.value = 440; // default in Herz angegeben

const audioControl = audioContext.createGain(); // ähnlich wie Amplitude.
audioControl.gain.value = 0;

oscillator.connect(audioControl); // Verbinden
